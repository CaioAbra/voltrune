...
@section('content')
    <h1>Minha conta administrativa</h1>
    <p>Atualize sua senha de acesso ao backoffice interno da Voltrune.</p>
    ...
    <section class="hub-card">
        <h2>Alterar senha</h2>
        <form class="hub-auth-form" method="post" action="{{ route('hub.admin.account.password.update') }}">
            @csrf
