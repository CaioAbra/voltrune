    ...
    <section class="hub-card solar-settings">
        ...
        <form action="{{ route('solar.settings.update') }}" method="post" class="hub-auth-form">
            ...
            <div class="hub-card hub-card--subtle">
                ...
                <p class="hub-note">Quando esta empresa tiver configuracoes salvas, novos projetos passam a herdar automaticamente a potencia padrao do modulo e o modelo padrao de inversor. Para preco por kWp, a prioridade agora e: valor da empresa, media regional por UF e depois fallback nacional de {{ 'R$ ' . number_format((float) $marketPricePerKwp, 2, ',', '.') }}/kWp. O instalador ainda pode ajustar esses campos manualmente em cada projeto.</p>
            </div>
