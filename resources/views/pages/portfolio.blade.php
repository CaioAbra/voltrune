...
<section class="section">
    <div class="container">
        <div class="filter-row" role="group" aria-label="Filtros de portfolio">
            <button class="filter-btn is-active" type="button" data-filter="all">Todos</button>
            <button class="filter-btn" type="button" data-filter="site">Sites</button>
            <button class="filter-btn" type="button" data-filter="app">Apps</button>
            <button class="filter-btn" type="button" data-filter="midia">Midia</button>
            <button class="filter-btn" type="button" data-filter="marca">Marca</button>
        </div>

        <div class="portfolio-grid" data-portfolio-grid>
            <x-portfolio-card title="Institucional para industria" description="Nova plataforma para captacao B2B com SEO." :tags="['site','seo','empresa']" result="+62% formularios validos" :image="asset('images/folio-1.svg')" />
            <x-portfolio-card title="Aplicativo de atendimento" description="Fluxo digital para profissionais liberais." :tags="['app','automacao']" result="-41% tempo de resposta" :image="asset('images/folio-2.svg')" />
